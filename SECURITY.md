...
We are committed to providing security updates for the following versions of **expenses-tracker-cli**:
...
We sincerely appreciate the efforts of security researchers and users who responsibly disclose vulnerabilities. Your contributions help us keep **expenses-tracker-cli** secure for everyone.

If you discover a security vulnerability within **expenses-tracker-cli**, please report it to us privately through GitHub's security advisory process. This is our preferred method, as it allows us to address the issue before public disclosure.

**How to Report:**

1. Navigate to the **Security** tab of our repository:  
   [https://github.com/sajjad-developer/expenses-tracker-cli/security](https://github.com/sajjad-developer/expenses-tracker-cli/security)
...
3. Fill out the form with as much detail as possible, including:
   ...
   - The affected version(s) of **expenses-tracker-cli**.
